  ...
  return (
    <Section className="text-center py-32 md:py-48">
      ...
      <div className="mt-12 group">
        <button onClick={onApplyClick} className="relative px-12 py-6 text-xl font-bold text-white uppercase overflow-hidden transition-all duration-300 border-2 border-transparent hover:border-[#00F2FF]">
